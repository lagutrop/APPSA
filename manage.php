...
<html>
	...
	<body ng-app="backoffice">
		...
		<div class="container-fluid dashboard-container">
			<div class="row">
				<nav class="col-xs-12 col-sm-2 col-md-2 bg-faded sidebar">
                    <ul id="sociosManagament" class="nav nav-pills flex-column">
						<li class="nav-item">
                    ...
                    <ul id="accountManagament" class="nav nav-pills flex-column">
                        <li class="nav-item">
                            <a id="change" class="nav-link" href="#!mudarPassword">Mudar password</a>
                        </li>
                    </ul>
				</nav>
                <main class="dashboard col-12 col-sm-10 col-md-10 ml-auto">
					<div ng-view></div>
				</main>
			</div>
		</div>
        ...
        <script src="controllers/mudarSenhaController.js"></script>
	</body>
</html>